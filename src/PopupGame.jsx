    ...
    popups: [
      {
        ...
        flag: 'FAKE DOMAIN',
        explanation: 'Real SeaGear Marine emails come from seagearmarine.com/. The countdown resets on loop - the prize never disappears. You cannot win a competition you never entered.',
      },
      {
  ...
  },
  {
    ...
    popups: [
      ...
      },
      {
        ...
        body: 'Storm season at Seabright Harbor - watch now on youtube.com',
        domain: 'youtube.com',
        mark: 'youtube.com',
        flag: 'OFFICIAL DOMAIN',
      ...
      },
      {
        ...
        body: 'The Harbor Kitchen · Arriving in ~25 min · Track at doordash.com',
        domain: 'doordash.com',
        mark: 'doordash.com',
        flag: 'OFFICIAL DOMAIN',
    ...
    popups: [
      {
        ...
        explanation: 'Same looping timer trick - different fake domain. seabright-prizes-online.net is not SeaGear Marine. The timer resets forever. There is no prize.',
      },
      {
